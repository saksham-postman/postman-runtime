...
module.exports = {
    ...
    process: {
         ...
         */
        async event (payload, next) {
            console.log('payload-runtime', payload);
            ...
            console.log('payload.context.vaultSecrets', payload.context.vaultSecrets);

            const vaultSecrets = payload.context.vaultSecrets;

            console.log('vaultSecrets:', vaultSecrets);
            console.log('allowScriptAccess type:', typeof vaultSecrets._.allowScriptAccess);

            // eslint-disable-next-line one-var
            const isVaultAccessAllowed = vaultSecrets._.allowScriptAccess;

            console.log('isVaultAccessAllowed type:', typeof isVaultAccessAllowed);

            // eslint-disable-next-line one-var
            const allowVaultAccess = typeof isVaultAccessAllowed === 'function' ?
                await isVaultAccessAllowed() :
                isVaultAccessAllowed;

            console.log('allowVaultAccess 1:', allowVaultAccess);
