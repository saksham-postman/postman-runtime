...
module.exports = {
    ...
    process: {
        ...
        async event (payload, next) {
            ...
            console.log(item, 'item at runtime');
            // eslint-disable-next-line @stylistic/js/max-len
            console.log(typeof isVaultAccessAllowed, 'isVaultAccessAllowed at runtime');
            if (typeof isVaultAccessAllowed === 'function') {
                allowVaultAccess = await isVaultAccessAllowed(item.id);
            }
            else {
