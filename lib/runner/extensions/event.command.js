...
module.exports = {
    ...
    process: {
        ...
        event (payload, next) {
            ...
            console.log('vault function - change', _.get(vaultSecrets, '_.allowScriptAccess'));

            // eslint-disable-next-line one-var
            const isVaultAccessAllowed = _.get(vaultSecrets, '_.allowScriptAccess'),
                allowVaultAccess = isVaultAccessAllowed();


            console.log('isVaultAccessAllowed', isVaultAccessAllowed);
