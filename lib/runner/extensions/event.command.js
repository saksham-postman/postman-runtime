    ...
    process: {
        ...
        async event (payload, next) {
            var item = payload.item,
                ...
                isVaultAccessAllowed = vaultSecrets._.allowScriptAccess,
                allowVaultAccess,
                packageResolver = _.get(this, 'options.script.packageResolver'),
                events;

            console.log(item, isVaultAccessAllowed, isVaultAccessAllowed(), 'item at runtime');
            // eslint-disable-next-line @stylistic/js/max-len
            console.log(typeof isVaultAccessAllowed, typeof isVaultAccessAllowed.then, 'isVaultAccessAllowed at runtime');
